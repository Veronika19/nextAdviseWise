        ...
        <div>
          <nav className="2xl:px-0 xl:px-16 px-0">
            <div className="hidden lg:flex items-center justify-between">
              <Link href="/">
                <a>
                  <Image src="/logo2.png" alt="logo" width={270} height={100} />
                </a>
              </Link>
              <ul className="flex">
                <li
                  className={
                    router.pathname == '/'
                      ? 'flex item-center text-lg font-bold text-red tracking-wide '
                      : 'flex item-center text-lg text-white tracking-wide ml-8'
                  }
                >
                  <Link href="/">
                    ...
                    {show1 && (
                      ...
                      >
                        <li className="hover:opacity-75 font-bold text-sm text-red px-2 py-2 hover:bg-red hover:text-gray-800">
                          <Link href="/about">
                            <a onClick={() => setShow1(!show1)}>All Category</a>
                          </Link>
                        </li>
                        <li className="hover:opacity-75 font-bold mt-1 text-sm text-red px-2 py-2 hover:bg-red hover:text-gray-800">
                          <Link href="/team">
                            <a onClick={() => setShow1(!show1)}>Our Team</a>
                          </Link>
                        </li>
                      </ul>
                    )}
                ...
                {/* <li
                  className={
                    checkActive() == 'projects'
                      ? 'text-lg font-bold text-indigo-700 tracking-wide ml-8'
                      : 'text-lg text-dark tracking-wide ml-8'
                  }
                >
              ...
              <div className="flex items-center">
                ...
                >
                  ...
                  />
                  <path
                    d="M10 14.0912C11.864 14.0912 13.375 12.4926 13.375 10.5207C13.375 8.54877 11.864 6.9502 10 6.9502C8.13607 6.9502 6.62503 8.54877 6.62503 10.5207C6.62503 12.4926 8.13607 14.0912 10 14.0912Z"
                    fill="white"
                    stroke="currentColor"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                ...
                <svg
                  className="ml-6 text-dark cursor-pointer"
                  xmlns="http://www.w3.org/2000/svg"
                  width={27}
                  height={24}
                  viewBox="0 0 27 24"
                ...
                >
                  <path
                    d="M3.58824 1H8.76471L11.3529 7.47059L8.11765 9.41177C9.50359 12.222 11.778 14.4964 14.5882 15.8824L16.5294 12.6471L23 15.2353V20.4118C23 21.0982 22.7273 21.7565 22.2419 22.2419C21.7565 22.7273 21.0982 23 20.4118 23C15.3638 22.6932 10.6026 20.5496 7.02648 16.9735C3.45042 13.3974 1.30677 8.63625 1 3.58824C1 2.90179 1.27269 2.24346 1.75808 1.75808C2.24346 1.27269 2.90179 1 3.58824 1Z"
                    fill="white"
                  />
                  <path
                    d="M3.58824 1H8.76471L11.3529 7.47059L8.11765 9.41176C9.50359 12.222 11.778 14.4964 14.5882 15.8824L16.5294 12.6471L23 15.2353V20.4118C23 21.0982 22.7273 21.7565 22.2419 22.2419C21.7565 22.7273 21.0982 23 20.4118 23C15.3638 22.6932 10.6026 20.5496 7.02648 16.9735C3.45042 13.3974 1.30677 8.63625 1 3.58824C1 2.90179 1.27269 2.24346 1.75808 1.75808C2.24346 1.27269 2.90179 1 3.58824 1"
                    stroke="currentColor"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
          ...
          <nav className="lg:hidden relative z-40">
            <div className="flex pt-4 justify-between items-center">
              ...
              <div className="visible flex items-center">
                ...
                >
                  <li
                    className="flex cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none"
