...
function Button({
  ...
  if (submit)
    finalClass += ' text-white bg-blue-400 border-blue-400 hover:bg-blue-600 hover:border-blue-600';
    ...
    finalClass += ' text-white bg-red-600 border-red-600 hover:bg-red-800 hover:border-red-800';
    ...
    finalClass += ' text-black bg-gray-200 border-gray-200 hover:bg-gray-400 hover:border-gray-400';
  else if (type === 'dark')
    finalClass += ' text-white bg-gray-900 border-gray-900 hover:bg-black hover:border-black';
  ...
  return (
    <ButtonTag href={link} className={finalClass} type={submit ? 'submit' : ''} {...newProps}>
      {content}
    </ButtonTag>
  );
}
